...
# Memory tools (remember, recall_about_me) are intentionally EXCLUDED here —
# Sonic's soul/memory is parked pending the user-consent decision. SuperSonic
# uses them via ALL_TOOLS because its only user is Boss himself.
RESEARCH_TOOLS = [
    search_web,
    get_quote,
    get_bars,
